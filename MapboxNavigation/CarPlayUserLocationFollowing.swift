...
public class CarPlayUserLocationFollowing: MLNUserLocationAnnotationView {
    ...
    private func setupLayers() {
        ...
        if puckImageView == nil {
            ...
            let puckImage = CarPlayNavigationStyleKit.imageOfUserLocationPuckFollowing(puckColor: .systemBlue)
            puckImageView = UIImageView(image: puckImage)
            puckImageView.transform = CGAffineTransformMakeScale(1.0, 0.8)
